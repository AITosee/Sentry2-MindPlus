...
namespace Sentry {
    ...
    export function BeginIIC(parameter: any) {
        ...
        Generator.addDeclaration("SentryObject",`sentry = Sentry(${addr})`,true);
    ...
    export function BeginUART(parameter: any) {
        ...
        Generator.addDeclaration("SentryObject",`sentry = Sentry()`,true);
        Generator.addCode(`sentry.begin(uart)`);
    }
    ...
    export function GetVisionResult(parameter: any) {
        let vision_type = parameter.VISION_TYPE.code;
        Generator.addCode(`sentry.GetValue(${vision_type}, kStatus)`);
    }
    ...
    export function GetValue(parameter: any) {
        ...
        Generator.addCode(`sentry.GetValue(${vision_type},${obj},${num})`);
    }
    ...
    export function GetColorValue(parameter: any) {
        ...
        Generator.addCode(`sentry.GetValue(kVisionColor,${obj},${num})`);
    }
    ...
    export function GetClass20Lable(parameter: any) {
        ...
        Generator.addCode(`sentry.GetValue(kVision20Classes,${obj},${num})`);
    }
    ...
    export function GetCardLable(parameter: any) {
        ...
        Generator.addCode(`sentry.GetValue(kVisionCard,${obj},${num})`);
    }
